    ...
    <div className="w-full max-w-7xl mx-auto space-y-4 lg:space-y-6">
      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-landing-blue-600 via-landing-blue-700 to-landing-blue-800 p-6 lg:p-8 text-white">
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold">Your Plan</h1>
          </div>
      ...
      <Card className="border-2 shadow-xl bg-white/80 backdrop-blur-sm">
        ...
        <CardContent className="space-y-4 lg:space-y-6">
          <div className="p-5 bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl border-2 border-purple-100">
          ...
          {subscription?.currentPeriodEnd && (
            <div className="flex items-center gap-3 p-4 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-xl border-2 border-blue-100">
      ...
      {!nextPlan && (
        <Card className="border-2 border-green-200 shadow-xl bg-white/80 backdrop-blur-sm">
          <CardContent className="pt-6">
            <div className="flex items-start gap-4 p-5 bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl border-2 border-green-200">
