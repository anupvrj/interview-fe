  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <Code
          className="absolute text-blue-200 opacity-20 w-16 h-16 animate-float"
          style={{
            top: "10%",
            left: "5%",
            animationDelay: "0s",
        ...
        />
        <Briefcase
          className="absolute text-indigo-200 opacity-20 w-12 h-12 animate-float"
          style={{
            top: "20%",
            right: "10%",
            animationDelay: "2s",
        ...
        />
        <Award
          className="absolute text-purple-200 opacity-20 w-14 h-14 animate-float"
          style={{
            top: "60%",
            left: "8%",
            animationDelay: "4s",
        ...
        />
        <Target
          className="absolute text-blue-200 opacity-20 w-10 h-10 animate-float"
          style={{
            top: "80%",
            right: "15%",
            animationDelay: "1s",
        ...
        />
        <Users
          className="absolute text-purple-200 opacity-20 w-16 h-16 animate-float"
          style={{
            top: "70%",
            left: "15%",
            animationDelay: "5s",
        ...
        />
        <Award
          className="absolute text-indigo-200 opacity-20 w-14 h-14 animate-float"
          style={{
            top: "50%",
            right: "20%",
            animationDelay: "2.5s",
                ...
                appearance={{
                  elements: {
                    ...
                    socialButtonsBlockButtonText:
                      "font-normal text-sm flex items-center",
                    ...
                    footerActionLink:
                      "text-blue-600 hover:text-blue-700 font-normal hover:underline text-sm",
                    identityPreviewText: "text-gray-700 font-normal",
                    formResendCodeLink:
                      "text-blue-600 hover:text-blue-700 font-normal hover:underline",
                    otpCodeFieldInput:
                      "border border-gray-300 focus:border-blue-500 rounded-lg h-12",
                    formFieldInputShowPasswordButton:
                      "text-gray-500 hover:text-gray-700",
                    formFieldAction:
                      "text-sm text-blue-600 hover:text-blue-700 font-normal hover:underline",
                    footer: "hidden",
                    formFieldRow: "mb-4",
                  },
                  layout: {
