...
const STEPS = [
  ...
  },
  {
    ...
    body: "Create 30–60 minute availability slots when it suits you. Add a Google Meet or Zoom link, choose which rounds you can take, and control visibility with Available, Away, or Offline.",
  },
  {
    icon: ShieldCheck,
