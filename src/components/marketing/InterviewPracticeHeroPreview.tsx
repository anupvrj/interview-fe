...
function InterviewSessionCard() {
  ...
  return (
    <div className="relative w-full min-w-0 shake-vertical">
      <div
        className="pointer-events-none absolute inset-0 hidden rotate-3 rounded-3xl bg-primary opacity-10 md:block"
        aria-hidden="true"
      />
      <div className="relative w-full overflow-hidden rounded-2xl border-2 border-border bg-card shadow-2xl">
        ...
        <div className="relative z-10 p-4 md:p-6">
          ...
          <div className="relative mb-4 md:mb-6">
            ...
            >
              <div className="mb-3 rounded-lg border border-border bg-white/80 p-3 backdrop-blur-sm md:mb-4 md:p-4">
                ...
                <p className="break-words text-sm leading-relaxed text-slate-900 md:text-base">
              ...
              <div className="rounded-lg border border-border bg-white/60 p-3 backdrop-blur-sm md:p-4">
                ...
                <p className="break-words text-sm italic leading-relaxed text-slate-700">
          ...
          <div className="grid min-w-0 grid-cols-3 gap-2 border-t border-border pt-4 md:gap-4">
            <div className="min-w-0 text-center">
              <div className="mx-auto w-[3.25rem] text-xl font-bold tabular-nums text-primary md:w-[3.5rem] md:text-2xl">
                {confidence.toFixed(1)}
              </div>
              <div className="mt-1 text-[10px] text-primary md:text-xs">Confidence</div>
            </div>
            <div className="min-w-0 text-center">
              <div className="mx-auto w-[3.25rem] text-xl font-bold tabular-nums text-green-600 md:w-[3.5rem] md:text-2xl">
                {Math.round(accuracy)}%
              </div>
...
export function InterviewPracticeHeroPreview() {
  return (
    <div className="relative mx-auto w-full min-w-0 max-w-[600px] sm:max-w-[700px]">
