...
export function TemplatePreview({
  ...
  // If template has a preview image (actual screenshot), show it
  if (
    template.preview &&
    template.preview.startsWith("/resume-template-images/")
  ) {
    return (
      <div
  ...
  // Otherwise, show custom preview based on template ID
  return (
    <div
      className="h-64 lg:h-72 bg-white rounded-t-lg relative overflow-hidden border-b-2"
      style={{ borderColor: template.colors.primary }}
    >
      {/* Clean Slate - Two-Column with Icon Contact */}
      {template.id === "clean-slate" && (
        <div
          className="absolute inset-0 p-3 text-xs"
          style={{ fontFamily: template.layout.fontFamily }}
        >
          {/* Header - Name, Title, Contact Icons */}
          <div className="mb-2">
            <h3
            ...
            <div
              className="flex items-center gap-2 text-[6px] flex-wrap"
              style={{ color: template.colors.text }}
            >
              <span>✉ p.sharma@email.com</span>
          ...
          <div className="flex gap-2">
            ...
            <div className="w-[60%] space-y-1.5">
              ...
              <div>
                <h4
                  className="text-[8px] font-bold text-center py-0.5 border-t border-b"
                  style={{
                ...
                <p
                  ...
                  style={{ color: template.colors.text }}
                >
                  Experienced Cloud and DevOps Engineer with six years in the
                  field...
                </p>
              </div>
              ...
              <div>
                ...
                <div className="mt-0.5 space-y-1">
                  <div className="text-[6px]">
                    <p className="font-bold">Cloud Infrastructure Engineer</p>
                    <p className="italic">
                      CloudSphere Solutions • 09/2023 - Present
                    </p>
                    <p className="text-[5px] mt-0.5 leading-tight">
                      • Architected multi-tier AWS environments
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-[40%] space-y-1.5">
              ...
              <div>
                ...
                <div
                  ...
                  style={{ color: template.colors.text }}
                >
                  <p className="font-bold">Master of Science</p>
                  <p>Bangalore Institute • 2014-2016</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {template.id === "executive" && (
        ...
        >
          ...
          <div className="mb-2">
            <h4
              className="font-bold text-[9px] mb-1 text-center"
              style={{ color: template.colors.primary }}
            >
              PROFILE
            </h4>
            <p
              ...
              style={{ color: template.colors.text }}
            >
              Innovative professional with 5+ years of experience...
            </p>
          </div>
          <div className="mb-2">
            <h4
            ...
            <div className="text-[7px]">
              ...
              <p className="mt-0.5">• Led cloud-native development</p>
            </div>
          </div>
          <div>
            <h4
      ...
      {template.id === "corporate" && (
        ...
        >
          <div className="w-2/3 p-3 text-xs">
            ...
            <div className="mb-2">
              <h4
                className="font-bold text-[8px] mb-1"
                style={{ color: template.colors.primary }}
              >
                EXPERIENCE
              </h4>
              <div className="text-[7px]">
                ...
                <p className="mt-0.5">• Cloud-native applications</p>
            ...
            <div>
              ...
              <p className="text-[7px]">
                ...
                <br />
                <span style={{ color: template.colors.secondary }}>
                  UC Berkeley • 2019
                </span>
              </p>
            </div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[6px]" style={{ color: template.colors.text }}>
                JavaScript
                <br />
                TypeScript
                <br />
      ...
      {template.id === "classic" && (
        ...
        >
          <div className="text-center mb-2">
            ...
            <div
              className="border-t-2 border-b-2 py-1 my-1"
              style={{ borderColor: template.colors.primary }}
            >
              <p className="text-[8px]" style={{ color: template.colors.text }}>
                john@email.com | +1 (555) 123-4567 | San Francisco, CA
              </p>
            </div>
          </div>
          <div className="mb-2">
            <h4
              className="font-bold text-[9px] text-center mb-1"
              style={{
            ...
            <p
              className="text-[7px] text-justify leading-tight"
              style={{ color: template.colors.text }}
            >
              Innovative professional with 5+ years of experience in software
      ...
      {template.id === "harvard" && (
        ...
        >
          <div
            ...
            style={{ borderBottom: `3px solid ${template.colors.primary}` }}
          >
            <h3
          ...
          <div className="mb-2">
            ...
            <div className="text-[7px]">
              <p className="font-semibold">Senior Software Engineer</p>
              <p style={{ color: template.colors.secondary }}>
                Tech Corp, San Francisco • 2021-Present
              </p>
              <p className="mt-0.5">• Led cloud development team</p>
            </div>
          </div>
        </div>
      )}
      ...
      {template.id === "atlantic-blue" && (
        ...
        >
          ...
          >
            ...
            <div className="mb-2">
              <h4
                className="font-bold text-[7px] mb-1"
          ...
          <div className="w-2/3 p-3">
            <div className="mb-2">
              ...
              <p
                ...
                style={{ color: template.colors.text }}
              >
                Innovative professional with expertise in full-stack
                development...
              </p>
            </div>
            <div>
              ...
              <div className="text-[7px]">
                ...
                <p className="mt-0.5">• Led cloud development</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            <div className="col-span-2 space-y-2">
              ...
              <div>
                ...
                <p className="text-[7px] font-semibold">Senior Engineer</p>
                <p
                  className="text-[6px]"
                  style={{ color: template.colors.secondary }}
                >
      ...
      {template.id === "hunter-green" && (
        ...
        >
          <div className="w-7/12 p-3">
            ...
            <div className="mb-2">
              <h4
                className="font-bold text-[8px] mb-1 pb-0.5"
                style={{
                  color: template.colors.primary,
      ...
      {template.id === "powder-blush" && (
        ...
        >
          <div
            className="h-1/4 p-2 flex items-center justify-center"
            style={{ backgroundColor: template.colors.primary, color: "white" }}
          >
          ...
          <div className="p-3 text-xs space-y-1.5">
            <div>
              <h4
                className="font-bold text-[8px] mb-0.5"
                style={{
                  color: template.colors.primary,
              ...
              <p className="text-[7px]" style={{ color: template.colors.text }}>
                Creative professional with passion for design...
              </p>
            </div>
            <div>
              <h4
              ...
              <p className="text-[7px] font-semibold">Designer</p>
              <p
                className="text-[6px]"
                style={{ color: template.colors.secondary }}
              >
                Creative Studio • 2021-Present
              </p>
            </div>
            <div>
              <h4
              ...
              <p className="text-[6px]">Figma • Photoshop • Illustrator</p>
            </div>
          </div>
        </div>
      )}
      ...
      {template.id === "emerald-mist" && (
        ...
        >
          ...
          <div
            className="w-2/5 p-2"
            style={{ backgroundColor: template.colors.accent, color: "white" }}
          >
            <div className="mb-2">
              <h4 className="font-bold text-[8px] mb-1">SKILLS</h4>
            ...
            <div>
              <h4 className="font-bold text-[8px] mb-1">CONTACT</h4>
              <p className="text-[6px]">
                San Francisco, CA
                <br />
